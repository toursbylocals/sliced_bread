...
export default function Keywords() {
  ...
  return (
    <GridContainer className="sticky top-0 left-0 h-screen overflow-y-clip">
      ...
      <motion.div
        ...
        className="absolute top-0 left-1/2 -translate-x-1/2 rotate-[85deg] bg-primary-100 pointer-events-none h-[105vw]"
      ></motion.div>
    </GridContainer>
  );
}
