...
import GalleryWithModal from "@/components/gallery/GalleryWithModal";

export const HeroBlock = () => {
  const images = [
    "/images/gallery/gallery-1-optimized.webp",
    "/images/gallery/gallery-2-optimized.webp",
    "/images/gallery/gallery-3-optimized.webp",
    "/images/gallery/gallery-4-optimized.webp",
    "/images/gallery/gallery-5-optimized.webp",
    "/images/gallery/gallery-6-optimized.webp"
  ];
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row mb-8">
        <div className="relative w-[400px] min-h-[400px]  flex-[0_0_auto] lg:mr-[100px] mb-8">
        ...
        <div className="text-lg leading-6 max-w-[700px] hero-text">
          ...
          <p>
            Choose the size that fits your lifestyle: MountainSoul water is available in a variety
            of bottle sizes, from convenient on-the-go options to larger formats perfect for home or
            office use. Whether you need a quick refresh or hydration for the whole day, we’ve got
            you covered.
          </p>
        </div>
      </div>
