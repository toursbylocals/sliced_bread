          ...
          <div className="flex flex-col gap-y-8">
            <div className="flex flex-col gap-y-3">
              ...
              <Typography variant="description" color="text-primary-300">
                ...
                we collect, use, and safeguard the information you provide when
                you purchase our products. Information We Collect: Customer
                Name: To personalize your experience and manage your orders.
                Quantity of Drinks: To fulfill your order accurately. Location
                Information (City, State/Province, Country): To ensure timely
                delivery and comply with regional regulations.
              </Typography>
            </div>
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <Typography variant="description" color="text-primary-300">
                ...
                our services, and communicating with you regarding your
                purchases. We do not sell or share your personal data with third
